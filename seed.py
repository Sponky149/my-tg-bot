...
from backend.database import SessionLocal, Item, Case, CaseItem
 
db = SessionLocal()
 
# ЧЕСТНЫЕ фиксированные веса по редкости - одинаковые для всех кейсов,
# никак не зависят от истории игрока или суммы депозита
RARITY_WEIGHT = {
    "common": 70,
    "rare": 20,
    "epic": 8,
...
if existing > 0:
    print(f"В базе уже есть {existing} предметов, пропускаю наполнение (чтобы не плодить дубли).")
    db.close()
    sys.exit(0)
 
# ============================================================
# 25 ПРЕДМЕТОВ (брейнротов)
# ============================================================
items_data = [
    # common (10)
...
for data in items_data:
    item = Item(**data)
    db.add(item)
    db.flush()  # чтобы сразу получить item.id
...
# ============================================================
# 7 КЕЙСОВ - в каждом по 8 предметов, честные фиксированные веса
# ============================================================
cases_data = [
    {
        "name": "Lucky Case", "price": 49,
        "item_names": [
            "Bombardiro Crocodilo", "Tung Tung Tung Sahur", "Boneca Ambalabu",
            "Chimpanzini Bananini", "Lirili Larila",
            "Tralalero Tralala", "Ta Ta Ta Sahur",
            "Blueberrinni Octopusini",
        ],
    },
    {
        "name": "Crazy Case", "price": 79,
        "item_names": [
            "Brr Brr Patapim", "Girafa Celestre", "Frigo Camelo",
            "Bobritto Bandito", "Espresso Signora", "Tric Trac Baraboom",
            "Cappuccino Assassino",
            "Odin Din Din Dun Boom",
        ],
    },
    {
        "name": "Mystery Case", "price": 99,
        "item_names": [
            "Trippi Troppi", "Bombardiro Crocodilo",
            "U Din Din Din Dun", "Piccione Macchina", "Cocofanto Elefanto",
            "Garama and Madundung", "Trulimero Trulicina",
            "Los Tralaleritos",
        ],
    },
    {
        "name": "Rich Case", "price": 149,
        "item_names": [
    ...
    {
        "name": "Legend Case", "price": 249,
        "item_names": [
            "Espresso Signora", "Cocofanto Elefanto",
            "Garama and Madundung", "Trulimero Trulicina", "La Vacca Saturno Saturnita",
            "Cappuccino Assassino",
            "Odin Din Din Dun Boom", "Los Tralaleritos",
        ],
    },
    {
        "name": "Guest Case", "price": 666,
        "item_names": [
            "Cappuccino Assassino", "Garama and Madundung", "Blueberrinni Octopusini",
            "Trulimero Trulicina", "La Vacca Saturno Saturnita",
            "Odin Din Din Dun Boom", "Los Tralaleritos",
            "Cocofanto Elefanto",
        ],
    },
